...
Mergesort processes each chromosome in an input file separately in order to increase speed. This increases the amount of memory consumed- you can disable this with the {-}{-}nosplit option.
