...
OpenGE supports both BAM and SAM formats as inputs for all commands. By default, results are written in BAM format; experimental SAM support is also present. To write in SAM format, specify a filename with a .sam or .SAM extension.
...
\subsection {convert}
The convert command has been removed- all functionality is available as part of the view command. See the "File formats" section above for more details.
